...
const props = defineProps({
  ...
  yesterdayValue: { type: Number},
  data: { type: Array, default: [] },
  wrzValue: { type: Number},
  grzValue: { type: Number},
});
