<template>
      ...
      <div class="title display_flex justify-content_flex-start align-items_center leftTop-radius layout_title px-2">
        ...
        <div style="width:calc(100% - 250px);" class="div-swiper">          
          <div class="swiper-slide" style="width: 50%;"
            :class="Drpswiper == '63405800' && 'swiper-slide swiper-slide-thumb-active'" @click="qiehuan('63405800')">
            芦潮港
          </div>
          <div class="swiper-slide" style="width:50%;"
            :class="Drpswiper == '63405900' && 'swiper-slide swiper-slide-thumb-active'" @click="qiehuan('63405900')">
            金山嘴
          </div>       
        </div>
  ...
  const dateid = ref("taifengZS");
  const stime = ref({});
  const etime = ref({});
  const stcdList = ref("63405800");
  const onetitleName = ref("台风风暴潮");
