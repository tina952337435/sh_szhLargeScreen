<template>
  <div class="m-box">
    <div class="title display_flex justify-content_flex-start align-items_center leftTop-radius layout_title px-2">
      <div class="d1"></div>
      <div class="d2"></div>
      <p class="base-p1" id="title2" @click="fangda()">蒸发量信息</p>
    ...
    <div class="txt">
      <el-table :data="tableData" style="width: 96%;height:100%;--el-table-border-color:none;margin:auto;"
        ...
        <el-table-column label="2025年" header-align="center" align="center">
          <template #default="scope">
            <span>{{ scope.row.year2025 }}</span>
          </template>
        </el-table-column>
        <el-table-column label="2024年" header-align="center" align="center">
          <template #default="scope">
            <span>{{ scope.row.year2024 }}</span>
          </template>
        </el-table-column>
        <el-table-column label="2023年" header-align="center" align="center">
          <template #default="scope">
            <span>{{ scope.row.year2023 }}</span>
          </template>
        </el-table-column>
...
function Weacontent() {
  tableData.value = props.strJsonZF;
}
