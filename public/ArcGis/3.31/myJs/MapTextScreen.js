...
define(["dojo/_base/declare",
    ...
    "dojo/domReady!"], function (declare, Graphic, Geometry, Point, Extent, on, lang, Evented, dom, domStyle, domConstruct, domUtils, screenUtils) {
        return declare([Evented], {
            ...
            _place: "top",
            _level: 11,
            constructor: function (map, mappoint, attr, text, visiblelevel, place, className, offset,htmlText) {
                this._map = map;
                this._text = text;
                this._attr = attr;
                ...
                if (text.toString().indexOf("</") > -1) {
                    ...
                    var DATAArr = text.split("@")[1].split("#");
                    ...
                    if (tempClass.indexOf("@") > -1) {
                        ...
                        markerContent += "<div class='amap-info-content" + this._place + "'>";
                        markerContent += " <div class='amap-info-title'>" + STNM + "</div>";
                        if (htmlText != "") {
                            markerContent += " <div class='amap-info-title-content'>" + htmlText + "</div>";
                        }
                        if (DATA != "") {
                            for (var num = 0; num < DATAArr.length; num++) {
                                markerContent += " <div class='amap-info-title-content'>" + DATAArr[num] + "</div>";
                            }
                        }
                        markerContent += "</div>";
                        markerContent += '<div class="amap-info-sharp"></div>';
                        markerContent += "</div>";
                        
                    } else {
                        if (this._place == "bottom") {
                            markerContent = "<div class='amap-ui-district-cluster-marker marker" + this._place + " MapTextNew " + tempClass + "'>";
                            markerContent += '<div class="amap-info-sharp" style="margin-top: 15px;"></div>';
                            markerContent += "<div class='amap-info-content" + this._place + "'>";
                            markerContent += "<div class='amap-info-title'>" + STNM + "</div>";
                            ...
                            if (DATA != "") {
                                for (var num = 0; num < DATAArr.length; num++) {
                                    if (DATAArr[num].indexOf("：") > -1) {
                                        var str = DATAArr[num].split("：");
                                        if (str[0] != undefined && str[1] != undefined) {
                                            markerContent += " <div class='amap-info-title-content'><span style='padding-right: 0px;'>" + str[0] + "：</span><span style='color: #00fff9;padding-left: 0px;'>" + str[1] + "</span></div>";
                                        }
                                    }
                                    else {
                                        markerContent += " <div class='amap-info-title-content'><span style='padding-right: 0px;'>" + DATAArr[num] + "</span></div>";
                                    }
                                }
                            }
                            markerContent += "</div>";
                            ...
                            if (DATA != "") {
                                for (var num = 0; num < DATAArr.length; num++) {
                                    if (DATAArr[num].indexOf("：") > -1) {
                                        var str = DATAArr[num].split("：");
                                        if (str[0] != undefined && str[1] != undefined) {
                                            markerContent += " <div class='amap-info-title-content'><span>" + str[0] + "：</span><span style='color: #00fff9;'>" + str[1] + "</span></div>";
                                        }
                                    } else {
                                        markerContent += " <div class='amap-info-title-content'><span style='padding-right: 0px;'>" + DATAArr[num] + "</span></div>";
                                    }
            ...
            drawText: function () {
                ...
                this._width = this._node.firstElementChild.offsetWidth;
                this._height = this._node.firstElementChild.offsetHeight;
                this.setOffset();
                try {
            ...
            setOffset: function () {
                ...
                if (this._place == "top") {
                    this._offsetX = 0 - 35;
                    this._offsetY = 0 - this._height - this._offset - 40;
                }
                else if (this._place == "bottom") {
                    this._offsetX = 0 - 35;
                    this._offsetY = this._offset - 5;
                }
                    ...
                    this._offsetX = this._offset - 5;
                    this._offsetY = 0 - this._height / 2 - 5;
                }
                ...
                else if (this._place == "leftcenter") {
                    this._offsetX = 0 - 35;
                    this._offsetY = 0 - this._height - this._offset - 40;
                }
            },
