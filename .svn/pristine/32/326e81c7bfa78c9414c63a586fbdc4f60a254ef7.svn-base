    ...
    <div class="m-box">
        <div class="title display_flex justify-content_flex-start align-items_center leftTop-radius layout_title px-2">
            <div style="line-height:30px;">
                <div class="d1"></div>
                <div class="d2"></div>
                <p class="base-p" id="title2" v-if="showClick" @click="fangda()">交换程序监控</p>
                <span class="spanTitle"></span>
            </div>
        </div>
        <div class="txt">
            <div class="m-list5" id="zbTable" style="margin-top:35px;margin-left: revert;">
                    <div class="web-box">
                        <ul>
    <li>
        <div class="div-circle" style="border: 3px solid #0DD3ED;">
            <p class="div-circle-info">正常</p>
        </div><div class="div-circle-title">
            <div style="color:#0DD3ED;margin-top:25px;"><b>办公室传真</b></div>
        </div>
    </li>
    <li>
        <div class="div-circle" style="border: 3px solid #0DD3ED;">
            ...
            <div style="color:#0DD3ED;margin-top:25px;"><b>水文模型</b></div>
        </div>
    </li>
    <li>
        <div class="div-circle" style="border: 3px solid #0DD3ED;">
            ...
            <div style="color:#0DD3ED;margin-top:25px;"><b>实时数据交换</b></div>
        </div>
    </li>
    <li>
        <div class="div-circle" style="border: 3px solid #0DD3ED;">
            ...
            <div style="color:#0DD3ED;margin-top:25px;"><b>智能预警提醒</b></div>
        </div>
    </li>
</ul>
                    </div>
...
.left-conter {
       ...
       .right-conter-item{
        ...
        .m-list5 .gallery-thumbs .swiper-slide, .m-list2 .gallery-thumbs1 .swiper-slide{
            width:33%;
        }
        .div-circle {
