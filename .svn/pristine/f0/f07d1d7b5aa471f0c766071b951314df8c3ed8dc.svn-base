<template>
  <div class="m-box m-box-3" style="position: relative">
    <div class="title display_flex justify-content_flex-start align-items_center leftTop-radius layout_title px-2">
      <div class="d1"></div>
      <div class="d2"></div>
      <p class="base-p" id="title2" @click="fangda()">日常养护</p>
    ...
    <div class="txt">
      <el-table :data="tableData" @row-click="handleclick"
        ...
        <el-table-column label="河道名称" prop="pathname" style="width:40%" align="center" :show-overflow-tooltip="true">
        </el-table-column>
        <el-table-column label="行政" prop="cityname" style="width:20%" align="center">
        </el-table-column>
        <el-table-column label="时间" prop="tm" style="width:20%" align="center">
        </el-table-column>
        <el-table-column label="类型" prop="typename" style="width:20%" align="center" :show-overflow-tooltip="true">
        </el-table-column>
      </el-table>
    </div>
    <div class="bot"></div>
...
function Weacontent() {
  ...
  api.RcyhdailySelectList(strParam)
    .then(res => {
      ...
      if (strJson.length > 0) {
        for (var num = 0; num < strJson.length; num++) {
          ...
          if (strJson[num].typename == "1") {
            item["typename"] = "绿色";
          } else if (strJson[num].typename == "2") {
            item["typename"] = "黄色";
          } else if (strJson[num].typename == "3") {
            item["typename"] = "红色";
          }
