<template>
    <div class="m-box">
        <div class="title display_flex justify-content_flex-start align-items_center leftTop-radius layout_title px-2">
            <div class="d1"></div>
            <div class="d2"></div>
            <p class="base-p" id="title2" @click="fangda()">省市边界污染物通量</p>
            <span class="spanTitle"></span>
        </div>
        <div class="txt">
            <div class="grid grid-cols-2 gap-4">
                <div class="bg-blue-900 bg-opacity-30 p-3 rounded-lg">
                    <div class="text-sm text-blue-300">长江</div>
                ...
                <div class="bg-green-900 bg-opacity-30 p-3 rounded-lg">
                    <div class="text-sm text-green-300">黄浦江</div>
                ...
                <div class="bg-yellow-900 bg-opacity-30 p-3 rounded-lg">
                    <div class="text-sm text-yellow-300">苏州河</div>
                    <div class="text-xl font-bold">734.8亿m³</div>
                    <div class="text-xs mt-1">较去年 <span class="text-green-400">+18.7%</span></div>
                </div>
                <div class="bg-purple-900 bg-opacity-30 p-3 rounded-lg">
                    <div class="text-sm text-purple-300">太浦河</div>
