<template>
  ...
  <ComZujian :showDialog="showDialog" @close="showDialog = false" :title="titleName" :typeValue="typeValue"
    ...
    <yubaoDanZhanLineChart :ZhanDanSW="ZhanDanSW" :DD_ARR="DD_ARR" :key="datekeyDialog" />
  </ComZujian>
</template>
<script setup>
...
const dateid = ref("yubaoSWLineYB");
