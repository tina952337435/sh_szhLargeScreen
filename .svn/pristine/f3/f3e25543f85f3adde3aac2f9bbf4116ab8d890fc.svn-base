    ...
    <div class="m-box">
        <div class="title display_flex justify-content_flex-start align-items_center leftTop-radius layout_title px-2">
            <div style="line-height:30px;">
                <div class="d1"></div>
                <div class="d2"></div>
                <p class="base-p" id="title2" @click="fangda()">预报预警</p>
            </div>
        </div>
        <div class="txt" style="overflow-y: auto">
            <div class="widget-ylTable-box">
                <div class="liuyupjbg" v-for="(item, index) in tableData" :key="index">
                    <p :title="item.name">{{ item.name }}</p>
                    <h3 class="c24c9ff">{{ item.value }}</h3>
                </div>
            </div>
                ...
                <div class="warnItem flexDivCol">
                    ...
                    <div class="warnBox flexDivCol flexSA">
                        <div class="warnLine flexDiv flexSB">
                            ...
                            <div class="warnNum theNum">7</div>
                        </div>
                        <div class="warnLine flexDiv flexSB">
                            <div class="warnType flexDiv">
                            ...
                            <div class="warnNum theNum">1</div>
                        </div>
                        <div class="warnLine flexDiv flexSB">
                            <div class="warnType flexDiv">
                ...
                <div class="warnItem flexDivCol">
                    ...
                    <div class="warnBox flexDivCol flexSA">
                        <div class="warnLine flexDiv flexSB">
                            ...
                            <div class="warnNum theNum">8</div>
                        </div>
                        <div class="warnLine flexDiv flexSB">
                            <div class="warnType flexDiv">
                            ...
                            <div class="warnNum theNum">2</div>
                        </div>
                        <div class="warnLine flexDiv flexSB">
                            <div class="warnType flexDiv">
