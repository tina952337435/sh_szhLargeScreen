<template>
    <div class="m-box" style="position: relative">
        <div class="title display_flex justify-content_flex-start align-items_center leftTop-radius layout_title px-2">
            <div class="d1"></div>
            <div class="d2"></div>
            <p class="base-p" id="title2" @click="fangda()">数据库资源</p>
            <div style="width:calc(100% - 220px);margin-left:90px;" class="div-swiper">
...
const dateid = ref('shujuliang111');
...
function Weacontent() {
    ...
    const _Option = ChartJs.chartYL("", strJson, strNote, LineColor, "数量(万)", "true", _theme, "", "", 0);
    lineOption.value = _Option;
