<template>
  <div class="m-box">
    <div class="title display_flex justify-content_flex-start align-items_center leftTop-radius layout_title px-2">
      <div class="d1"></div>
      <div class="d2"></div>
      <p class="base-p1" id="title2" @click="fangda()">流量信息</p>
    ...
    <div class="txt">
      <el-table :data="tableData" style="width: 96%;height:100%;--el-table-border-color:none;margin:auto;"
        ...
        <el-table-column fixed label="名称" prop="stnm" width="180" header-align="center" align="center"
        ...
        <el-table-column label="流量(m³/s)" header-align="center" align="center">
          <template #default="scope">
...
function Weacontent() {
  tableData.value = props.strJsonLL;
}
