    ...
    <div class="m-box">
        <div class="title display_flex justify-content_flex-start align-items_center leftTop-radius layout_title px-2"
            ...
            <div style="line-height:30px;">
                <div class="d1"></div>
                <div class="d2"></div>
                <p class="base-p" id="title2" @click="fangda()">水文简报</p>
            </div>
...
function getPDF(title, wd_file) {
    ...
    var ChildVue = defineAsyncComponent(() => 
        import("@/components/top/pdf.vue")
    );
    //ChildVue为弹窗中嵌入的slot
    Dialog.open({ title:title, widh: 1500, heig: 800 }, h(ChildVue, props)).then(() => { console.log('弹窗关闭了') })
}
function fangda() {
